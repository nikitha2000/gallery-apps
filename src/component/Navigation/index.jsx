  ...
  return (
    <>
            ...
            <NavLink
              ...
              className={`flex items-center h-12 px-2.5 py-0 text-base font-poppins tracking-wide leading-snug ${
                selectedNavItem === item.name
                  ...
                  :"bg-white text-dark-grey font-semibold"
              }`}
      ...
      <div className="block justify-between items-center pb-8 sm:block md:flex px-4 xl:px-8 2xl:px-20">
        ...
        <div className="flex justify-center items-center w-auto h-8 border-2 border-purple-grey rounded-lg p-2 box-content md:w-w-499">
          <input
            type="text"
        ...
        <div className="pt-5 md:pt-0">
          <Button
            label="New"
            className="bg-white flex flex-wrap justify-center items-center border border-light-grey rounded-md w-24 h-12 px-5 font-semibold text-md text-black font-poppins"
          />
        </div>
      </div>
    </>
